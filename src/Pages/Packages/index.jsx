...
import sampleFilePackages from "../../Assets/docs/Solution_Design_Details_for_Package.docx";
...
const QUERYpackages = (orderBy, orderDirection) => {
  return gql`
...
const PackageLisiting = (props) => {
  ...
  const handleSubmitReviewer = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        await axios.post(
          "https://codehub.indusnettechnologies.com/api/sendEmail",
          emailpayload,
          {
            headers: {
              Authorization: "Bearer " + item,
  ...
  const editServiceSchema = Yup.object({
    ...
    techStack: Yup.string()
      .min(6, "Tech Stack must be at least 6 characters")
      .required("Please enter Tech Stack"),
    description: Yup.string()
      .min(20, "Description must be at least 20 characters")
      .required("Please enter description"),
    repoLinks: Yup.string()
      .url("Repo Link must be a valid Link")
      .required("Please enter repo link"),
  ...
  const { data, loading, error, refetch } = useQuery(
    QUERYpackages(orderBy, orderDirection),
    {
        ...
        await axios
          ...
          .then(async (res) => {
            ...
            await axios
              ...
              .then((res) => {
                successInputSwal("Created Package Successfully");
                refetch(res);
                closeModal();
              })
              .catch((er) => {
  ...
  const packageArray = data?.services?.data;
  ...
  const handleDownload = (e) => {
    ...
    link.download = "Solution_Design_Details_for_Package";

    link.href = sampleFilePackages;
      ...
      <AuthenticatePages>
        <div className="container pt-2">
          <div style={{ marginTop: "15px" }}>
            ...
            》<span className="breadcrum">Packages</span>
          </div>
          <h1 className="fs-2 fw-bold text-dark font_cern pt-4">Packages</h1>
                      ...
                      <>
                        <tr>
                          ...
                          <td>
                            ...
                            (isAdmin ||
                              userData.email === e.attributes.reviewerEmail) ? (
                              <td
                                style={{
                                  borderColor: "transparent",
                                  cursor:"pointer"
          ...
          <div>
            <Modals
              headerName={packageId == null?"Create Package":"Edit Package"}
              showModal={showModal}
                  ...
                  <div className="">
                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                      <div className="row">
                        ...
                        <div className="form-group col">
                          <label for="repoLinks">Repo Link</label>
                          <input
                            style={{
                              backgroundColor: "transparent",
                              color: "black",
                        ...
                        <div className="form-group col">
                          ...
                          <Tippy
                            ...
                            content={
                              ...
                              >
                                <span>Download Sample Package file</span>
                              </span>
                            }
                          >
                            <span
